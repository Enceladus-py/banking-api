...
import com.fintech.banking.coreapi.transaction.infrastructure.adapter.out.event.OutboxEventScheduler;
...
import com.fintech.banking.coreapi.transaction.infrastructure.adapter.out.persistence.repository.SpringDataProcessedEventRepository;
...
class TransactionOutboxIntegrationTest {
	...
	void setUp() {
		...
		var userEntity = new com.fintech.banking.coreapi.user.infrastructure.adapter.out.persistence.entity.UserJpaEntity(
				UUID.fromString(userId), "Integration", "Tester", null);
		var profileEntity = new com.fintech.banking.coreapi.user.infrastructure.adapter.out.persistence.entity.ProfileJpaEntity(
				UUID.randomUUID(), userEntity, "Integration", "Tester", null, null);
		userEntity.setProfile(profileEntity);
		userRepository.save(userEntity);

		// Save test account
		var accountEntity = new com.fintech.banking.coreapi.account.infrastructure.adapter.out.persistence.entity.AccountJpaEntity(
