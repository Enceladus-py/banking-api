...
import com.fintech.banking.coreapi.common.infrastructure.security.SecurityConfig;
import com.fintech.banking.coreapi.transaction.application.port.in.DepositMoneyUseCase;
import com.fintech.banking.coreapi.transaction.application.port.in.DepositMoneyUseCase.DepositCommand;
...
class TransactionControllerTest {
	...
	@MockitoBean
	private com.fintech.banking.coreapi.common.infrastructure.security.JwtService jwtService;
	...
	void shouldReturn200AndTransactionResponseWhenGettingById() throws Exception {
		...
		String requesterId = "USER-123";
		com.fintech.banking.coreapi.transaction.domain.model.TransactionRecord tx = com.fintech.banking.coreapi.transaction.domain.model.TransactionRecord
				.reconstitute(txId, "ACC-SRC", "ACC-TGT", new java.math.BigDecimal("50.00"),
						com.fintech.banking.coreapi.transaction.domain.model.TransactionRecord.TransactionType.TRANSFER,
						java.time.Instant.now(),
						com.fintech.banking.coreapi.transaction.domain.model.TransactionRecord.TransactionStatus.COMPLETED,
						null);
	...
	void shouldReturn200WhenDepositIsSuccessful() throws Exception {
		...
		TransactionRecord updatedTx = TransactionRecord.reconstitute("tx-id", null, accountNumber,
				new BigDecimal("100.00"), TransactionRecord.TransactionType.DEPOSIT, java.time.Instant.now(),
	...
	void shouldReturn200AndUpdatedAccountOnSuccessfulWithdrawal() throws Exception {
		...
		TransactionRecord expectedTx = TransactionRecord.reconstitute("tx-id", accountNumber, null,
				new BigDecimal("150.00"), TransactionRecord.TransactionType.WITHDRAWAL, java.time.Instant.now(),
				TransactionRecord.TransactionStatus.PENDING, null);
