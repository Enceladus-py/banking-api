...
class UserControllerTest {
	...
	void shouldRegisterUserSuccessfully() throws Exception {
		com.fintech.banking.coreapi.user.domain.model.User user = com.fintech.banking.coreapi.user.domain.model.User
				.reconstitute("uuid-123", "alice@example.com", "pwd", Profile.createNew("Alice", "Smith"), 1L);
	...
	void shouldUpdateProfileSuccessfully() throws Exception {
		...
		com.fintech.banking.coreapi.user.domain.model.User updatedUser = com.fintech.banking.coreapi.user.domain.model.User
				.reconstitute("uuid-123", "alice@example.com", "pwd",
