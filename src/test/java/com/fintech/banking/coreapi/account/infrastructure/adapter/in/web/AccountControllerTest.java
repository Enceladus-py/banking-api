...
class AccountControllerTest {
	...
	void shouldReturn200WhenAccountIsCreated() throws Exception {
		...
		Account mockDomainAccount = Account.reconstitute("uuid-1", "USER-123", "ACC1234567", BigDecimal.ZERO);
	...
	void shouldReturn200AndAccountDetailsWhenGettingAccount() throws Exception {
		...
		Account mockAccount = Account.reconstitute("uuid-1", requesterId, accountNumber, new BigDecimal("250.00"));
	...
	void shouldReturn200AndAccountsWhenGettingAccounts() throws Exception {
		String requesterId = "USER-123";
		Account mockAccount = Account.reconstitute("uuid-1", requesterId, "1234567890", new BigDecimal("250.00"));
		com.fintech.banking.coreapi.common.application.port.in.dto.PageRequest pageRequest = new com.fintech.banking.coreapi.common.application.port.in.dto.PageRequest(
				0, 10);
		com.fintech.banking.coreapi.common.application.port.in.dto.PageResult<Account> mockPageResult = new com.fintech.banking.coreapi.common.application.port.in.dto.PageResult<>(
