...
class CommandValidationTest {
	...
	void shouldCreateValidUpdateProfileCommand() {
		com.fintech.banking.coreapi.user.application.port.in.UpdateProfileUseCase.UpdateProfileCommand command = new com.fintech.banking.coreapi.user.application.port.in.UpdateProfileUseCase.UpdateProfileCommand(
	...
	void shouldThrowExceptionWhenUpdateProfileCommandHasInvalidParameters() {
		assertThrows(NullPointerException.class,
				() -> new com.fintech.banking.coreapi.user.application.port.in.UpdateProfileUseCase.UpdateProfileCommand(
						null, "+123456", "Main St"));
		assertThrows(IllegalArgumentException.class,
				() -> new com.fintech.banking.coreapi.user.application.port.in.UpdateProfileUseCase.UpdateProfileCommand(
						"   ", "+123456", "Main St"));
