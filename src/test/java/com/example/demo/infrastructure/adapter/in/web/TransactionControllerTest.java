...
class TransactionControllerTest {
	...
	void shouldReturn200AndTransactionResponseWhenGettingById() throws Exception {
		...
		String requesterId = "USER-123";
		com.example.demo.domain.model.TransactionRecord tx = new com.example.demo.domain.model.TransactionRecord(txId,
				"ACC-SRC", "ACC-TGT", new java.math.BigDecimal("50.00"),
				com.example.demo.domain.model.TransactionRecord.TransactionType.TRANSFER, java.time.LocalDateTime.now(),
				com.example.demo.domain.model.TransactionRecord.TransactionStatus.COMPLETED, null);
