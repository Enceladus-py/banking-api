...
class TransactionRecordTest {
	...
	void shouldCreateValidDepositRecord() {
		TransactionRecord record = new TransactionRecord(null, "TARGET1234", new BigDecimal("100.00"),
	...
	void shouldThrowExceptionWhenDepositHasSourceAccount() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord("SOURCE1234", "TARGET1234", new BigDecimal("100.00"),
					TransactionRecord.TransactionType.DEPOSIT);
		});
	...
	void shouldThrowExceptionWhenTransferHasSameSourceAndTarget() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord("SAME123456", "SAME123456", new BigDecimal("100.00"),
	...
	void shouldThrowExceptionForZeroOrNegativeAmount() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord(null, "TARGET1234", BigDecimal.ZERO, TransactionRecord.TransactionType.DEPOSIT);
		});
	...
	void shouldThrowExceptionForNullAmount() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord(null, "TARGET1234", null, TransactionRecord.TransactionType.DEPOSIT);
		});
		assertEquals("Transaction amount must be strictly positive", ex.getMessage());
	}
	...
	void shouldThrowExceptionForNullType() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord(null, "TARGET1234", new BigDecimal("100.00"), null);
		});
	...
	void shouldThrowExceptionWhenSourceAndTargetAreBothNull() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord(null, null, new BigDecimal("100.00"), TransactionRecord.TransactionType.TRANSFER);
		});
	...
	void shouldThrowExceptionWhenWithdrawalMissingSourceAccount() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord(null, "TARGET1234", new BigDecimal("100.00"),
					TransactionRecord.TransactionType.WITHDRAWAL);
		});
	...
	void shouldThrowExceptionWhenTransferMissingTargetAccount() {
		IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> {
			new TransactionRecord("SOURCE1234", null, new BigDecimal("100.00"),
					TransactionRecord.TransactionType.TRANSFER);
		});
